...
function GrupoVip() {
    ...
    useEffect(() => {
        ...
        const redirectTimer = setTimeout(() => {
            window.location.href = "https://chat.whatsapp.com/G3Ur00PBB1A4Iq5Qudjm6p";
        }, 7000);
                    ...
                    <div className="w-full max-w-4xl mx-auto px-4 py-8 text-center">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-300 text-lg md:text-2xl max-w-2xl mx-auto leading-relaxed mb-8">
                                O Mega Desconto será Liberado no dia <strong className="text-white">05 e 06 de dezembro</strong>,
                                apenas para quem estiver no <strong className="text-green-400">Grupo Vip do WhatsApp</strong>.
                            </p>
                        </div>

                        <div className="flex flex-col items-center gap-6">
                            <a href="https://chat.whatsapp.com/G3Ur00PBB1A4Iq5Qudjm6p" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 text-white font-bold px-8 md:px-12 py-4 md:py-6 rounded-full transition-all duration-300 transform hover:scale-105 text-lg md:text-2xl shadow-xl shadow-green-500/30 flex items-center gap-3" onClick={() => window.fbq && window.fbq('track', 'Lead')}>
